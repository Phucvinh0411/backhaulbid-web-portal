...
export const getCarrierDetails = (bid) => {
  ...
  const carrierDatabase = {
    "Công ty Vận tải Phước An": {
      ...
      driverLicense: "Bằng FC (12 năm kinh nghiệm)",
    ...
    "Vận tải Đông Lạnh Meito": {
      ...
      driverLicense: "Bằng FC (15 năm kinh nghiệm)",
    ...
    "Logistics Bắc Nam T&T": {
      ...
      driverLicense: "Bằng FC (8 năm kinh nghiệm)",
    ...
    "Hợp tác xã Vận tải Hữu Nghị": {
      ...
      driverLicense: "Bằng C (10 năm kinh nghiệm)",
    ...
    "Vận tải Nội Bài Express": {
      ...
      driverLicense: "Bằng C (6 năm kinh nghiệm)",
      insuranceAmount: "1.0 Tỷ VNĐ",
  ...
  const defaultDetails = {
    ...
    driverLicense: "Bằng FC (7 năm kinh nghiệm)",
    insuranceAmount: "1.5 Tỷ VNĐ",
